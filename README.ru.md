...
Разработка ведётся в свободное время. Если BuzzMini пригодился, можно поддержать автора (**Тимур К.**) переводом через **CloudTips**:

- **Ссылка:** [страница сбора](https://pay.cloudtips.ru/p/3fbf7934)

В приложении: меню трея → **Donate — Донат** или вкладка **Donate** в окне Buzz Mini — там же текст, ссылка и этот QR.
